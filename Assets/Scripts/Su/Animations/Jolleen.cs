...
public class Jolleen : MonoBehaviour
{
    ...
    {
        cry, jump, idle, chase, attack, death, done, turrentEnter
    }
    ...
    public GameObject JolleenExternalRef; 
    ...
    private void Update()
    {
        ...
        else
        {
            ...
            if (_state == Girl_state.turrentEnter)
            {
                //gameObject.transform.position = Player_obj.transform.position;
                _nav.SetDestination(Player_obj.transform.position);
                
                /*
                if (Vector3.Distance(Player_obj.transform.position, transform.position) < 2.2f)
                {
                ...
                else if (_state == Girl_state.chase)
                {
                    if (Target_obj)
                    {
                        ...
                        else
                        {
                            ...
                            else if (Vector3.Distance(Player_obj.transform.position, transform.position) > Notice_range)
                            {
                                _ani.SetFloat("Speed", speed);
                                if(speed > 0.3){
                                    _nav.SetDestination(Player_obj.transform.position);
                            ...
                            else if (Vector3.Distance(Player_obj.transform.position, transform.position) > Attack_range)
                            {
                                _ani.SetFloat("Speed", speed);
                                if(speed > 0.6){
                                    _nav.SetDestination(Player_obj.transform.position);
                    ...
                    else
                    {
                        ...
                        {
                            if (Vector3.Distance(Player_obj.transform.position, transform.position) > 5)
                            {
                                _ani.SetFloat("Speed", speed);
                                _nav.SetDestination(Player_obj.transform.position);
                            }
                        ...
                        /*
                        if (Vector3.Distance(Player_obj.transform.position, transform.position) > 16)
                        {
                            _ani.SetFloat("Speed", speed);
                            _nav.SetDestination(Player_obj.transform.position);
                        }
